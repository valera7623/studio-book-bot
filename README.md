...
- Предоплата 50/100% и подписка владельца через ЮKassa (предпочтительно) или Prodamus; webhook идемпотентен; возврат при отмене по правилу 24–120 ч.
- Напоминания за 24 ч и за 2 ч, истечение hold (20 мин – 24 ч на студии). Бэкап SQLite в `data/backups/` и опционально `BACKUP_OFFSITE_DIR`.
...
- Чеки и возврат — через ЮKassa или Prodamus, не руками. Шаблон правил: `data/legal/cancel_rules.md`.
